...
--This function doesn't work as intended :( and will not return the correct answer
--If the inputs are "hello" and "elo", it returns 1 even though the string doesnt appear in "hello"
--This is because the function only checks if all the characters in the substring appear in the string in the correct order
